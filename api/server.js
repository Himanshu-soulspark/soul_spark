    ...
    try {
        ...
        if (coinCost > 0) {
            if (userData.coins < coinCost) {
                ...
                return res.status(403).json({ error: `इस जवाब के लिए ${coinCost} सिक्कों की ज़रूरत है, लेकिन आपके पास पर्याप्त सिक्के नहीं हैं।` });
            }
            // सिक्के अपडेट करें
...
// ज़रूरी: Womenhealth.html के लिए भी एक रास्ता जोड़ना अच्छी प्रैक्टिस है, हालांकि express.static इसे संभाल लेगा।
app.get('/Features/Womenhealth.html', (req, res) => res.sendFile(path.join(__dirname, '..', 'Features', 'Womenhealth.html')));
