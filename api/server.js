...
// *** यही वह ज़रूरी बदलाव है ***
try {
  // पहले जाँच करें कि वेरिएबल मौजूद है या नहीं
  if (!process.env.FIREBASE_SERVICE_ACCOUNT) {
    throw new Error('FIREBASE_SERVICE_ACCOUNT environment variable is not set!');
  }
  
  // JSON को पार्स करने की कोशिश करें
  ...
  // अगर कोई भी गड़बड़ होती है, तो साफ़-साफ़ बताएं
  console.error("\n\n❌❌❌ FATAL ERROR: Firebase Admin SDK could not be initialized. ❌❌❌");
  console.error("This is the most common reason for the server crashing at startup.\n");
  console.error("REASON:", error.message);
  console.error("\nSOLUTION: Please check your 'FIREBASE_SERVICE_ACCOUNT' environment variable in Render.");
  console.error("It is very likely that the JSON is not formatted correctly as a single line.\n");
  // सर्वर को यहीं रोक दें ताकि हमें पता चले कि समस्या यहीं है
  process.exit(1); 
}
